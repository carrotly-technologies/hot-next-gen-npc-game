...
class Entity(pygame.sprite.Sprite):
	...
	def change_facing_direction(self, target_pos):
		relation = pygame.math.Vector2(target_pos) - pygame.math.Vector2(self.rect.center)
...
class Character(Entity):
	...
	def has_los(self):
		if pygame.math.Vector2(self.rect.center).distance_to(self.player.rect.center) < self.radius:
	...
	def start_move(self):
		relation = (pygame.math.Vector2(self.player.rect.center) - pygame.math.Vector2(self.rect.center)).normalize()
